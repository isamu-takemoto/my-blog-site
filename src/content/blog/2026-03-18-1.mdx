...
今回は以前から気になっていた Text-to-SQL を、実務で感じていた課題を解決するかたちで試してみました。GCPのVertex AI（Gemini）を使い、BigQueryのデータに自然言語で質問できる[AIデータアシスタント](https://ai-data-platform-frontend-541263482647.asia-northeast1.run.app/)を作った話です。
